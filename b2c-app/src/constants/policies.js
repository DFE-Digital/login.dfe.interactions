export const POLICIES = {
    SIGNIN_INVITATION: 'B2C_1A_Signin_Invitation',
    ACCOUNT_SIGNUP: 'B2C_1A_Account_Signup',
    PASSWORD_RESET: 'B2C_1A_Password_Reset',
    PASSWORD_RESET_CONFIRMATION: 'B2C_1A_Password_Reset_Confirmation',
